                    ...
                    <>
                        <div className="bg-[#0d082d] text-white py-20 sm:pt- sm:mb-2 md:py-35 w-screen relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] md:pt-36 md:mb-20">
                            <div className="container mx-auto px-6 sm:px-5 md:px-1 lg:px-20 flex flex-col md:flex-row items-center justify-between">
                                ...
                                <img src="/assets/img/tech-hero-2.webp" alt="Hero Image" className="hidden md:block w-[1200px] md:ml-auto animate__animated animate__fadeInUp animate__delay-3s  md:scale-170 pt-15 lg:translate-x-30 filter drop-shadow-[0_35px_60px_#4426F0]" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div ref={projectsSectionRef} className="bg-gray-100 mt-[-78px] py-16 px-4 sm:px-8 lg:px-12 w-screen relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw]">
                            ...
                            <div className="text-center mb-12">
                                ...
                                <p className="text-lg text-gray-600">Explore some of our recent works.</p>
                            </div>
                            {/* Grid Proyek */}
                            <div
                            ...
                            >
                                ...
                                {listProyek.slice(0, visibleProjectsCount).map((proyek) => (
                                    <div
                                        key={proyek.id}
                                        className="bg-white shadow-lg hover:shadow-xl transition-transform duration-300 transform hover:-translate-y-2 overflow-hidden flex flex-col"
                                    >
                            ...
                            {isLoadMoreVisible && (
                                <div className="text-center mt-12">
                                    <button
                                        ...
                                        className=" text-gray-900 font-semibold py-3 px-8  transition-all duration-300 transform hover:scale-105"
                                    >
